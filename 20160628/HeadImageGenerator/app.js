...
(function () {
    ...
    var Config = Hiro.Config;
    var CenterCircle = Hiro.CenterCircle;
    ...
    Main.prototype.render = function () {
        this._context2d.clearRect(0, 0, Hiro.Config.CANVAS_WIDTH, Hiro.Config.CANVAS_HEIGHT);
    ...
    Main.prototype.redraw = function () {
        ...
        this._context2d.drawImage(this._sourceImage, 0, 0, Hiro.Config.CANVAS_WIDTH, Hiro.Config.CANVAS_HEIGHT);

        this._context2d.beginPath();
        this._context2d.rect(0, 0, Hiro.Config.CANVAS_WIDTH, Hiro.Config.CANVAS_HEIGHT);
